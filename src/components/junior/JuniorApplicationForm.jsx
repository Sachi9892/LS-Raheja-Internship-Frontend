...
import AddressForm from "../degree/AddressForm";
import PersonalInfoForm from "../degree/PersonalInfoForm";
import CompetitiveExamsForm from "../degree/CompetitiveFormExam";
import WorkExperienceForm from "../degree/WorkExperienceForm";
import QualificationForm from "../degree/QualificationForm";
import CourseTaughtForm from "../degree/CourseTaughtForm";
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/lsraheja/junior/apply-now",
        formData,
