            ...
            {!values.workExperience.isFresher && (
                <FieldArray name="workExperience.list">
                    {({ push, remove }) => {
                        ...
                        const hasCurrentlyWorking = values.workExperience.list.some(exp => exp.isCurrentlyWorking);

                        return (
                            <div>
                                {values.workExperience.list.map((experience, index) => {
                                    const isCurrentlyWorking = experience.isCurrentlyWorking;
                                        ...
                                        <div key={index} className="border p-4 rounded-lg mb-6 shadow-sm bg-gray-50">
                                            ...
                                            <div className="flex items-center gap-2 mt-3">
                                                <Field
                                                    ...
                                                    onChange={() => {
                                                        // Set notice period as mandatory if checked
                                                        setFieldValue(
                                            ...
                                            <Field
                                                ...
                                                as="select"
                                                disabled={!isCurrentlyWorking} // Disable if not currently working
                                                className="w-full p-2 border rounded-md mt-1 focus:ring-2 focus:ring-blue-400"
                                            >
